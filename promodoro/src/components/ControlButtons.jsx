...
const ControlButtons = ({ isRunning, handleStartPause, handleRestart, handleComplete, isDarkMode }) => (
  <div className="flex justify-center space-x-4 mt-8">
    ...
    <button
      ...
      className="px-8 py-2 rounded-full font-bold transition-all duration-300 bg-blue-500 text-white"
    >
      Complete
    </button>
  </div>
